...
use App\EventListener\EspecialidadImageSubscriber;
...
class EspecialidadType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->addEventSubscriber(new EspecialidadImageSubscriber($this->imageUploader, $this->entityManager, $this->targetDirectory));
    }
