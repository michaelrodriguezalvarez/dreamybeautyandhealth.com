    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add($builder->create('usuario', UserType::class, array(
                ...
                ->addEventSubscriber(new UserPasswordSubscriber($this->passwordEncoder, 'admin'))
            );
        ...
        $builder
            ...
            ->addEventSubscriber(new UserImageSubscriber($this->imageUploader, $this->entityManager, $this->targetDirectory, 'admin'));
    }
